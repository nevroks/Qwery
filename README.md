...
Тут присутвуют анимации написанные через js(там где нужно) и css,довольно хороший сайт но в макете небыло других страниц так чсто написаны просто заглушки, написан адаптивный слайдер и попап.<br/>
